			...
			if (stageSetting.objectArea !== null) {
				...
				for (var i = 0; i < configData.object.length; i++) {
					...
					if (configData.object[i].id == "refrigerator") {
						outputHtml += '<input type="checkbox" class="objet-selected editing" name="objet-selected" value="' + configData.object[i].id + '" id="' + configData.object[i].id + '-select" data-slide-index="' + configData.object[i].slideIndex + '">';
					} else {
				...
				// 메인 컬러 default 세팅
				// 왼쪽 냉장고
				document.getElementById("refrigerator_LT").src = "images/objet/simulator/appliances/rf/rf_door01_02st_green.png";
				document.getElementById("refrigerator_LB").src = "images/objet/simulator/appliances/rf/rf_door02_02st_silver.png";
				document.getElementById("refrigerator_RB").src = "images/objet/simulator/appliances/rf/rf_door03_02st_silver.png";
				$("#refrigerator_LT").val("st_green");
				$("#refrigerator_LB").val("st_silver");
				$("#refrigerator_RB").val("st_silver");
				...
				// 오른쪽 냉장고
				document.getElementById("refrigerator_convertible_L").src = "images/objet/simulator/appliances/rf_con/rf_con_03mg_mint.png";
				document.getElementById("refrigerator_convertible_M").src = "images/objet/simulator/appliances/rf_con/rf_con_02st_silver.png";
				simulator.setObject('refrigerator_convertible', 'refrigerator_convertible_L', 'mg_mint');
				simulator.setObject('refrigerator_convertible', 'refrigerator_convertible_M', 'st_silver');
				$("#refrigerator_convertible_L").val("mg_mint");
			...
			*/
			if (targetSideBarArea !== null && window.Scrollbar) {
				...
				if (window.Scrollbar.has(targetSideBarArea)) {
					window.Scrollbar.get(targetSideBarArea).destroy();
					if (ID === "refrigerator") {
						outputHtml += '<button type="button" id="refrigeratorSetBtn" class="mainColorSet"  style="font-size:15px; position:relative; margin:20px 0 0">refrigerator 본품컬러 선택</button>'
					} 
					if (targetID === 'refrigerator_convertible_L') {
						outputHtml += '<button type="button" id="convertibleLSetBtn" class="mainColorSet" style="font-size:15px; position:relative; margin:20px 0 0">convertibleL 본품컬러 선택</button>'
					} 
					if (targetID === 'refrigerator_convertible_M') {
						outputHtml += '<button type="button" id="convertibleMSetBtn" class="mainColorSet" style="font-size:15px; position:relative; margin:20px 0 0">convertibleM 본품컬러 선택</button>'
					}

					/* if (ID === 'refrigerator_convertible') {
						outputHtml += '<button type="button" id="rightDefaultSetBtn"  style="font-size:15px; position:relative; margin:20px 0 0">오른쪽 본품컬러 선택하기 이미지</button>'
					} */

            ...
            selections: [ // 가전 별 선택 가능한 영역
               {
                  ...
                  // defaultImage: 'appliances/rf/rf_door01_02st_green.png',
                  productInfo: { modelId: 'MD07545595' }, //장바구니 CTA - 제품모델명 추가 (Surface 컬러별 판넬 모델명 추가)
                  Surface: [
               ...
               },
               {
                  ...
                  // defaultImage: 'appliances/rf/rf_door02_02st_silver.png',
                  productInfo: { modelId: 'MD07545595' }, //장바구니 CTA - 제품모델명 추가 (Surface 컬러별 판넬 모델명 추가)
                  Surface: [
               ...
               },
               {
                  ...
                  // defaultImage: 'appliances/rf/rf_door03_02st_silver.png',
                  productInfo: { modelId: 'MD07545595' }, //장바구니 CTA - 제품모델명 추가 (Surface 컬러별 판넬 모델명 추가)
                  Surface: [
            ...
            selections: [
               {
                  ...
                  Surface: [
                     { colorCode: 'st_black', filename: 'appliances/rf_con/rf_con_02st_black.png', modelId: 'MD07553552' },
                     { colorCode: 'st_silver', filename: 'appliances/rf_con/rf_con_02st_silver.png', modelId: 'MD07553558' },
                     { colorCode: 'st_green', filename: 'appliances/rf_con/rf_con_02st_green.png', modelId: 'MD07553550' },
                     { colorCode: 'mg_beige', filename: 'appliances/rf_con/rf_con_03mg_beige.png', modelId: 'MD07553522' },
                     { colorCode: 'mg_pink', filename: 'appliances/rf_con/rf_con_03mg_pink.png', modelId: 'MD07553528' },
                     { colorCode: 'mg_mint', filename: 'appliances/rf_con/rf_con_03mg_mint.png', modelId: 'MD07553539' },
                     { colorCode: 'mg_silver', filename: 'appliances/rf_con/rf_con_03mg_silver.png', modelId: 'MD07553564' },
      ...
      initObjects: function () {
         if (stageSetting.objectArea !== null) {
            ...
            for (var i = 0; i < configData.object.length; i++) {
               ...
               outputHtml += '<input type="checkbox" class="objet-selected" name="objet-selected" value="' + configData.object[i].id + '" id="' + configData.object[i].id + '-select" data-slide-index="' + configData.object[i].slideIndex + '">';
               ...
               for (var j = 0; j < configData.object[i].selections.length; j++) {
                  ...
                  /*if(configData.object[i].id == "refrigerator"){
                      if(configData.object[i].selections[j].id == "refrigerator_LT" || configData.object[i].selections[j].id == "refrigerator_LB" || configData.object[i].selections[j].id == "refrigerator_RB"){
                          // Green & Silver
                          outputHtml += '<a href="#none" class="object-app selected select" data-object="' + configData.object[i].id + '" data-object-selector="' + configData.object[i].selections[j].id + '" ';
                      }else{
                          // Default
                  ...
                  outputHtml += 'id="' + configData.object[i].selections[j].id + '" ' +
               ...
               /*if(configData.object[i].id == "refrigerator"){
                   console.log("A")
                   // console.log(configData.object[i].selections[j]);
                   // console.log(configData.object[i].selections[j].defaultImage);

                   // $("#refrigerator_LT").val("st_green");
                   // $("#refrigerator_LB").val("st_silver");
                   // $("#refrigerator_RB").val("st_silver");

                   /!*if(configData.object[i].selections[j].id == "refrigerator_LT"){
                       $("#refrigerator_LT").val("st_green");
                   }else if(configData.object[i].selections[j].id == "refrigerator_LB" || configData.object[i].selections[j].id == "refrigerator_RB"){
                       $("#refrigerator_LB").val("st_silver");
                       $("#refrigerator_RB").val("st_silver");
                   }*!/
               }*/
            ...
            /*if(configData.object[0].id == "refrigerator"){
                $("#refrigerator_LT").val("st_green");
                $("#refrigerator_LB").val("st_silver");
                $("#refrigerator_RB").val("st_silver");
            }*/
            ...
            // $("#refrigerator_LB").val("st_silver");
            // $("#refrigerator_RB").val("st_silver");
            // _self.setObject('refrigerator', 'refrigerator_LT', 'st_green');
            // _self.setObject('refrigerator', 'refrigerator_LB', 'st_silver');
            // _self.setObject('refrigerator', 'refrigerator_RB', 'st_silver');

            // 오른쪽 냉장고
            // _self.setObject('refrigerator_convertible', 'refrigerator_convertible_L', 'st_silver');
            // _self.setObject('refrigerator_convertible', 'refrigerator_convertible_M', 'st_silver');
            ...
            if (tmpObject !== null) {
               for (var i = 0; i < tmpObject.length; i++) {
                  tmpObject[i].addEventListener('click', function () {
                     ...
                     // 오브젝트가 한번이라도 선택된 이후에 다른곳을 선택할때
                     // console.log("B", "오브젝트가 한번이라도 선택된 이후에 다른곳을 선택할때", this.dataset.object);
                  });
               }
            }
               ...
               for (var i = 0; i < tmpObject.length; i++) {
                  tmpObject[i].addEventListener('click', function () {
                     if (this.checked) {
                        ...
                        // 오브젝트에 처음 접근했을때
                        // console.log("A", "오브젝트에 처음 접근했을때",this.value);
                        ...
                        if (colorWarningPopup.classList.contains('actived')) {
                           colorWarningPopup.classList.remove('actived');
                        }
...
<<<<<<< HEAD:_server/objetCollection/js/objet/new_objet_simulator_core.js
...
=======
>>>>>>> 8c1594fe7274ced9bcbefb92783034e603cb0b01:02-Public/_backup/220517/objetCollection-mj/js/objet/new_objet_simulator_core.js
            var tmpObject = {
            ...
            if (existSelectionIndex == -1) {
               ...
               // console.log(configData.object[index].selections[selectionIndex].productInfo.modelId)
         ...
         var existObjects = userSelected.selectedObjet.filter(function (value) {
         ...
         if (existObjects[0].selectedObject_desc.length > 0 && !isFavSet && !isPassCheckColorGroup) {
            function colorGroupCheck() {
               var selectedColorGroupIndex = findGroupIndexByColorCode(index, colorCode); // 0 일때 메탈, 1 일때 글라스
            ...
            if (!colorGroupCheck()) { //서로 다른 그룹 호출 시 안내 alert 호출
               ...
               if (colorWarningPopup) {
                  ...
                  // colorWarningPopup.innerHTML = '<button type="button">refresh</button>';
         ...
         if (targetImage !== null) {
            ...
            // console.log('(targetImgFilename) '+targetImgFilename)
      ...
      updateSideBar: function (ID, targetID) {
         ...
         */
         ...
         for (var i = 0; i < arraySelectedSurface.length; i++) {
            ...
            outputHtml += '<div class="select_objet_item">';
            // outputHtml += '<p class="name">' + arraySelectedSurface[i].name + '<button type="button" class="btn-Tooltip" onClick="tooltipOpen(this);" value="'+ arraySelectedSurface[i].name +'">Tooltip</button></p>';
            ...
            // 판넬의 가격이 세트별로 동일하다면 (컬러코드 불러오는 부분도 동일하다는 전제로 작업되어있음)
            outputHtml += '<span style="position:absolute; top:0; right:-45px; color:red;">' + arraySelectedSurface[i].price + '</span>';

            outputHtml += '</p>';
            outputHtml += '<ul>';

            // console.log("1",arraySelectedSurface);
            // console.log("2",arraySelectedSurface[i]);
            // console.log("3",arraySelectedSurface[i].colors);
            ...
            for (var j = 0; j < arraySelectedSurface[i].colors.length; j++) {
               ...
               // 냉장고 default 색상 지정
               /*if(targetId == "refrigerator_LT" && i == 0 && j == 2 || targetId == "refrigerator_LB" && i == 0 && j == 1 || targetId == "refrigerator_RB" && i == 0 && j == 1){
                   outputHtml += '<button type="button" class="btn-objet active" ';
               }else{
                   outputHtml += '<button type="button" class="btn-objet ' + classes + '" ';
               }*/
               outputHtml += '<button type="button" class="btn-objet ' + classes + '" ';

               outputHtml += 'style="background-image:url(' + objectImageURL + arraySelectedSurface[i].colors[j].colorChip + ');" ';
               outputHtml += 'data-color-code="' + arraySelectedSurface[i].colors[j].colorCode + '" data-target-object="' + targetId + '" data-object-id="' + ID + '" data-link-name="' + slideLocation + '-' + arraySelectedName + '-' + arraySelectedSurface[i].colors[j].colorCode + '">';
               outputHtml += arraySelectedSurface[i].colors[j].name + '</button>';
               outputHtml += '</li>';
               // console.log("4",arraySelectedSurface[0].colors[2]);
         ...
         */
         if (targetSideBarArea !== null && window.Scrollbar) {
            if (window.Scrollbar.has(targetSideBarArea)) {
               ...
               /* 220510 start */
               if (ID === "refrigerator") {
                  outputHtml += '<button type="button" id="refrigeratorSetBtn" class="mainColorSet">refrigerator 본품컬러 선택</button>'
                  outputHtml += '<span style="margin: 10px 0 0; position: relative; top: 12px;left: 16px; color:red;">' + configData.object[0].mainColor[0].price + '</span>';
               }
               if (targetID === 'refrigerator_convertible_L') {
                  outputHtml += '<button type="button" id="convertibleLSetBtn" class="mainColorSet">convertibleL 본품컬러 선택</button>'
                  outputHtml += '<span style="margin: 10px 0 0; position: relative; top: 12px;left: 16px; color:red;">' + configData.object[1].mainColor[0].price + '</span>';
               }
               if (targetID === 'refrigerator_convertible_M') {
                  outputHtml += '<button type="button" id="convertibleMSetBtn" class="mainColorSet">convertibleM 본품컬러 선택</button>'
                  outputHtml += '<span style="margin: 10px 0 0; position: relative; top: 12px;left: 16px; color:red;">' + configData.object[1].mainColor[0].price + '</span>';
               }
               /* 220510 end */
         ...
         function objectActive(event) {
            ...
            if (!_this.classList.contains('active')) {
               ...
               if (_self.setObject(_this.dataset.objectId, _this.dataset.targetObject, _this.dataset.colorCode)) {
                  // console.log('objectId : ' + _this.dataset.objectId);
                  // console.log('targetObject : ' + _this.dataset.targetObject);
                  // console.log('colorCode : ' + _this.dataset.colorCode);

                  // button 선택시 color active 되라
                  ...
                  // console.log($("#" + _this.dataset.targetObject).val(_this.dataset.colorCode));
               }

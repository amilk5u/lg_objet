...
(function (objSimulator) {
	...
	var configData = { //환경 설정값 저장, JSON 정상 로딩 시 override 됨
		...
		backgroundImages: [
			{
				name: 'modern',
				images: ['bg_modern_01.png', 'bg_modern_02.png', 'bg_modern_03.png', 'bg_modern_03.png'] // mj 배경 이미지 
			},
			{
				name: 'nature',
				images: ['bg_nature_01.png', 'bg_nature_02.png', 'bg_nature_03.png', 'bg_nature_03.png']
			},
			{
				name: 'nordic',
				images: ['bg_nordic_01.png', 'bg_nordic_02.png', 'bg_nordic_03.png', 'bg_nordic_03.png']
			}
		],
		/* 220524 end */
		object: [
			...
			/* 220524 start */
			{
				...
				selectedImage: 'appliances/rf_bf/freezer_selected.png',
				slideIndex: 0,
				...
				selections: [ // 가전 별 선택 가능한 영역
					{
						...
						offset: { top: 328, left: 540, },
						size: { width: 155, height: 280, },
						placeholder: 'appliances/rf_bf/freezer_door01_nomal.png',
					...
					},
					{
						...
						size: { width: 155, height: 220, },
						placeholder: 'appliances/rf_bf/freezer_door02_nomal.png',
			...
			},
			{
				...
				icon: { default: 'Thumb_09.png', focus: 'Thumb_09_selected.png' },
				offset: { top: 537, left: 2277/*2277 6117 */, },

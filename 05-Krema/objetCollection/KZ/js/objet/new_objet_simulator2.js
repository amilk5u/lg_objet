...
$("#save").on("click", function () {
	...
	if ( $("#refrigerator_convertible_L").val() != "" || $("#refrigerator_convertible_M").val() != "" || ($("#refrigerator_LT").val() != "" && $("#refrigerator_LB").val() != "" && $("#refrigerator_RB").val() != "") || $("#oven").val() != "" || ($("#wash_T").val() != "" && $("#wash_B").val() != "") || $("#clean").val() != "" /*|| $("#styler").val() != ""*/  || ( $("#refrigerator_bottomFreezer_T").val() != "" && $("#refrigerator_bottomFreezer_M").val() != "" )  ) {
		let popCont = '';
		...
		if ($("#oven").val() != "") {//오븐
			...
			let arLink = 'javascript:comingSoon();';
			let target = 'target="_blank"';
			popCont += '';
			popCont += '<li>';
			popCont += '	<div class="pic_box">';

...
$("#save").on("click", function(){
    ...
    if($("#refrigerator_convertible_L").val() != "" || $("#refrigerator_convertible_M").val() != "" ||  ($("#refrigerator_LT").val() != "" && $("#refrigerator_LB").val() != "" && $("#refrigerator_RB").val() != "") || $("#oven").val() != "" || ($("#wash_T").val() != "" && $("#wash_B").val() != "") || $("#clean").val() != "" /*|| $("#styler").val() != ""*/ ){
        let popCont = '';
